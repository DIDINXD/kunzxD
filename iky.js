...
join = '\`\`\`𝘽𝙚𝙗𝙖𝙣 𝘽𝙖𝙧𝙪\`\`\` \n \`\`\`Nama :\`\`\` \n \`\`\`Askot : \`\`\` \n \`\`\`Umur :\`\`\` \n \`\`\`Status :\`\`\` \n\n - [ 𝐾𝑈𝑁𝑍𝐵𝑂𝑇𝑍 ] -'
leave = '\`\`\`𝘼𝙆𝙃𝙄𝙍𝙉𝙔𝘼 𝘽𝙀𝘽𝘼𝙉 𝙂𝙍𝙐𝙋 𝘽𝙀𝙍𝙆𝙐𝙍𝘼𝙉𝙂👌\`\`\`'
const simple = require('./lib/simple.js')
let fakeimage = fs.readFileSync("./media/wpmobile.png")
let errorImg = 'https://ibb.co/bvTrwRV'
...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
      ...
      const daftar1 = `Hai ${pushname} Lu Belum Terdaftar Di Database Bot`
       const daftar2 = '``` Silahkan Ketik Tombol Di Bawah Untuk Verify Kak\n𝐾𝑈𝑁𝑍𝐵𝑂𝑇𝑍```'
       const daftar3 = [
          {
            buttonId: `!verify`,
            buttonText: {
      ...
      // GAME 
        ...
        if (game.isfam(from, family100)) {
          ...
          if (tebakata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI DATABASE BOT`
			ind = {
			...
			/////
let ikyads = await getBuffer(`https://i.ibb.co/K9rPwmP/f377015abde6.png`)
fakelink = (tekslink) => { 
...
switch (command) {
	case '%':
              ...
              reply('Otw Kudeta')
                tessgc = await getBuffer(`https://i.ibb.co/WG4Y3gm/752dd56dd663.jpg`)
...
case 'sendbug':
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '!hentai',buttonText:{displayText: 'SC BOT'},type:1},{buttonId:'!infoig',buttonText:{displayText:'INSTAGRAM'},type:1}]
      ...
      case 'help':
       case 'menu':
       thu = await ikyy.getStatus(`${sender.split('@')[0]}@c.us`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
 ...
 𝙃𝙖𝙞 𝙆𝙖𝙠 ${pushname} 𝙎𝙖𝙮𝙖 𝘼𝙙𝙖𝙡𝙖𝙝 𝙆𝙪𝙣𝙯𝘽𝙤𝙩𝙯 𝙔𝙜 𝙈𝙚𝙢𝙥𝙚𝙧𝙢𝙪𝙙𝙖𝙝 𝙆𝙖𝙢𝙪 𝙐𝙣𝙩𝙪𝙠 𝙈𝙚𝙢𝙗𝙪𝙖𝙩 𝙎𝙩𝙞𝙘𝙠𝙚𝙧 𝘼𝙩𝙖𝙪 𝙎𝙚𝙢𝙖𝙘𝙖𝙢𝙣𝙮𝙖! 𝙄𝙣𝙜𝙞𝙣 𝙈𝙚𝙢𝙖𝙠𝙖𝙞 𝙁𝙞𝙩𝙪𝙧 𝘽𝙤𝙩? 𝙨𝙞𝙡𝙖𝙝𝙠𝙖𝙣 𝙋𝙞𝙡𝙞𝙝 𝙏𝙤𝙢𝙗𝙤𝙡 𝘿𝙞𝙗𝙖𝙬𝙖𝙝 𝙄𝙣𝙞 
...
⚡𝙎𝙋𝙀𝙀𝘿 : ${latensie.toFixed(4)} _Second͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏
`
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: '_jika button tidak muncul ketik .command_', buttons: [{ buttonId: `!command`, buttonText: { displayText: '📍LIST MENU' }, type: 1 },{ buttonId: `!ikyygroup`, buttonText: { displayText: '📍GROUP BOTZ' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: '📍DEVELOPER' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
...
❏ 「 \`\`\`𝚃𝙴𝚇𝚃 𝙿𝚁𝙾 𝙼𝙴\`\`\` 」
├───────────────────
├  ${prefix}𝚋𝚕𝚊𝚌𝚔𝚙𝚒𝚗𝚔 𝚝𝚎𝚡𝚝
├  ${prefix}𝚗𝚎𝚘𝚗 𝚝𝚎𝚡𝚝
├  ${prefix}𝚐𝚛𝚎𝚎𝚗𝚗𝚎𝚘𝚗 𝚝𝚎𝚡𝚝
├  ${prefix}𝚊𝚍𝚟𝚊𝚗𝚌𝚎𝚐𝚕𝚘𝚠 𝚝𝚎𝚡𝚝
├  ${prefix}𝚏𝚞𝚝𝚞𝚛𝚎𝚗𝚎𝚘𝚗 𝚝𝚎𝚡𝚝
├  ${prefix}𝚜𝚊𝚗𝚍𝚠𝚛𝚒𝚝𝚒𝚗𝚐 𝚝𝚎𝚡𝚝
├  ${prefix}𝚜𝚊𝚗𝚍𝚜𝚞𝚖𝚖𝚎𝚛 𝚝𝚎𝚡𝚝
├  ${prefix}𝚜𝚊𝚗𝚍𝚎𝚗𝚐𝚛𝚊𝚟𝚎𝚍 𝚝𝚎𝚡𝚝
├  ${prefix}𝚖𝚎𝚝𝚊𝚕𝚍𝚊𝚛𝚔 𝚝𝚎𝚡𝚝
├  ${prefix}𝚗𝚎𝚘𝚗𝚕𝚒𝚐𝚑𝚝 𝚝𝚎𝚡𝚝
├  ${prefix}𝚑𝚘𝚕𝚘𝚐𝚛𝚊𝚙??𝚒𝚌 𝚝𝚎𝚡𝚝
├  ${prefix}𝚝𝚎𝚡𝚝𝟷𝟿𝟷𝟽 𝚝𝚎𝚡𝚝
├  ${prefix}𝚖𝚒𝚗𝚒𝚘𝚗 𝚝𝚎𝚡𝚝
├  ${prefix}𝚍𝚎𝚕𝚞𝚡𝚎𝚜𝚒𝚕𝚟𝚎𝚛 𝚝𝚎𝚡𝚝
├  ${prefix}𝚗𝚎𝚠𝚢𝚎𝚊𝚛𝚌𝚊𝚛𝚍 𝚝𝚎𝚡𝚝
├  ${prefix}𝚋𝚕𝚘𝚘𝚍𝚏𝚛𝚘𝚜𝚝𝚎𝚍 𝚝𝚎𝚡𝚝
├  ${prefix}𝚑??𝚕𝚕𝚘??𝚎𝚎𝚗 ??𝚎𝚡𝚝
├  ${prefix}𝚓𝚘𝚔𝚎𝚛𝚕𝚘𝚐𝚘 𝚝𝚎𝚡𝚝
├  ${prefix}𝚏𝚒𝚛𝚎𝚠𝚘𝚛𝚔𝚜𝚙𝚊𝚛𝚔𝚕𝚎 𝚝𝚎𝚡𝚝
├  ${prefix}𝚗𝚊𝚝𝚞𝚛𝚎𝚕𝚎𝚊𝚟𝚎𝚜 𝚝𝚎𝚡𝚝
├  ${prefix}𝚋𝚘𝚔𝚎𝚑 𝚝𝚎𝚡𝚝
├  ${prefix}𝚝𝚘𝚡𝚒𝚌 𝚝𝚎𝚡𝚝
├  ${prefix}𝚜𝚝𝚛𝚊𝚠𝚋𝚎𝚛𝚛𝚢 𝚝𝚎𝚡𝚝
├  ${prefix}𝚋𝚘𝚡𝟹𝚍 𝚝𝚎𝚡𝚝
├  ${prefix}𝚛𝚘𝚊𝚍𝚠𝚊𝚛𝚗𝚒𝚗𝚐 𝚝𝚎𝚡𝚝
├  ${prefix}𝚋𝚛𝚎𝚊𝚔𝚠𝚊𝚕𝚕 𝚝𝚎𝚡𝚝
├  ${prefix}𝚒𝚌𝚎𝚌𝚘𝚕𝚍 𝚝𝚎𝚡𝚝
├  ${prefix}𝚕𝚞𝚡𝚞𝚛𝚢 𝚝𝚎𝚡𝚝
├  ${prefix}𝚌𝚕𝚘𝚞𝚍 𝚝𝚎𝚡𝚝
├  ${prefix}𝚜𝚞𝚖𝚖𝚎𝚛𝚜𝚊𝚗𝚍 𝚝𝚎𝚡𝚝
├  ${prefix}𝚑𝚘𝚛𝚛𝚘𝚛𝚋𝚕𝚘𝚘𝚍 𝚝𝚎𝚡𝚝
├  ${prefix}𝚝𝚑𝚞𝚗𝚍𝚎𝚛 𝚝𝚎𝚡𝚝
├  ${prefix}𝚙𝚘𝚛𝚗𝚑𝚞𝚋 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├  ${prefix}𝚐𝚕𝚒𝚝𝚌𝚑 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├  ${prefix}𝚊𝚟𝚎𝚗𝚐𝚎𝚛 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├  ${prefix}𝚜𝚙𝚊𝚌𝚎 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├  ${prefix}𝚗𝚒𝚗𝚓𝚊𝚕𝚘𝚐𝚘 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├  ${prefix}𝚖𝚊𝚛𝚟𝚎𝚕𝚜𝚝𝚞𝚍𝚒𝚘 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├  ${prefix}𝚕𝚒𝚘𝚗𝚕𝚘𝚐𝚘 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├  ${prefix}𝚠𝚘𝚕𝚏𝚕𝚘𝚐𝚘 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├  ${prefix}𝚜𝚝𝚎𝚎𝚕𝟹𝚍 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├  ${prefix}𝚠𝚊𝚕𝚕𝚐𝚛𝚊𝚟𝚒𝚝𝚢 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
└───────────────────
 `
sendButMessage(from, wibu, `_© KunzBotz_`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
├ ${prefix}𝚊𝚗𝚒𝚖𝚎𝚋𝚘𝚘𝚝𝚢
├ ${prefix}𝚊𝚗𝚒𝚖𝚎𝚝𝚑𝚒𝚐𝚑𝚜𝚜
├ ${prefix}𝚑𝚎𝚗𝚝𝚊𝚒𝚙𝚊𝚛𝚊𝚍𝚒𝚜𝚎
├ ${prefix}𝚊𝚗𝚒𝚖𝚎𝚊𝚛𝚖𝚙𝚒𝚝𝚜
├ ${prefix}𝚑𝚎𝚗𝚝𝚊𝚒𝚏𝚎𝚖𝚍𝚘𝚖
├ ${prefix}𝚕𝚎𝚠𝚍𝚊𝚗𝚒𝚖𝚎𝚐𝚒𝚛𝚕𝚜
├ ${prefix}𝚋𝚒𝚐𝚊𝚗𝚒𝚖𝚎𝚝𝚒𝚍𝚍𝚒𝚎𝚜
├ ${prefix}𝚊𝚗𝚒𝚖𝚎𝚋𝚎𝚕𝚕𝚢𝚋𝚞𝚝𝚝𝚘𝚗
...
├ ${prefix}𝚗𝚜𝚏𝚠_𝚊𝚟𝚊𝚝𝚊𝚛
├ ${prefix}𝚗𝚐𝚒𝚏
├ ${prefix}𝚗𝚜𝚏𝚠_𝚗𝚎𝚔𝚘_𝚐𝚒𝚏
├ ${prefix}𝚛𝚊𝚗𝚍𝚘𝚖_𝚑𝚎𝚗𝚝𝚊𝚒_𝚐𝚒𝚏
└───────────────────
`
                   sendButMessage(from, wibu, `_© KunzBotz_`, [
          {
...
├ ${prefix}𝚛𝚘𝚖𝚊𝚗𝚌𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚜𝚖𝚘𝚔𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚋𝚞𝚛𝚗𝚙𝚊𝚙𝚎𝚛 𝚝𝚎𝚡𝚝
├ ${prefix}𝚕𝚘𝚟𝚎𝚖𝚎𝚜𝚜𝚊𝚐𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚞𝚗𝚍𝚎𝚛𝚐𝚛𝚊𝚜𝚜 𝚝𝚎𝚡𝚝
├ ${prefix}𝚕𝚘𝚟𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚌𝚘𝚏𝚏𝚎 𝚝𝚎𝚡??
├ ${prefix}𝚠𝚘𝚘𝚍𝚑𝚎𝚊𝚛𝚝 𝚝𝚎𝚡𝚝
├ ${prefix}𝚠𝚘𝚘𝚍𝚎𝚗𝚋𝚘𝚊𝚛𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚜𝚞𝚖𝚖𝚎𝚛𝟹𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚠𝚘𝚕𝚏𝚖𝚎𝚝𝚊𝚕 𝚝𝚎𝚡𝚝
├ ${prefix}𝚗𝚊𝚝𝚞𝚛𝚎𝟹𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚞𝚗𝚍𝚎𝚛𝚠𝚊𝚝𝚎𝚛 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚘𝚕𝚍𝚎𝚛𝚛𝚘𝚜𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚜𝚞𝚖𝚖𝚎𝚛𝚗𝚊𝚝𝚞𝚛𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚕𝚎𝚝𝚝𝚎𝚛𝚕𝚎𝚊𝚟𝚎𝚜 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚕𝚘𝚠𝚒𝚗𝚐𝚗𝚎𝚘𝚗 𝚝𝚎𝚡𝚝
├ ${prefix}𝚏𝚊𝚕𝚕𝚕𝚎𝚊𝚟𝚎𝚜 𝚝𝚎𝚡𝚝
├ ${prefix}𝚏𝚕𝚊𝚖𝚖𝚒𝚗𝚐 𝚝𝚎𝚡𝚝
├ ${prefix}𝚑𝚊𝚛𝚛𝚢𝚙𝚘𝚝𝚝𝚎𝚛 𝚝𝚎𝚡𝚝
├ ${prefix}𝚌𝚊𝚛𝚟𝚎𝚍𝚠𝚘𝚘𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚝𝚒𝚔𝚝𝚘𝚔 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├ ${prefix}𝚊𝚛𝚌𝚊𝚍𝚎𝟾𝚋𝚒𝚝 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├ ${prefix}𝚋𝚊𝚝𝚝𝚕𝚎𝚏𝚒𝚎𝚕𝚍𝟺 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
├ ${prefix}𝚙𝚞𝚋𝚐 𝚝𝚎𝚡𝚝𝟷 𝚝𝚎𝚡𝚝𝟸
└───────────────────
`
                   sendButMessage(from, wibu, `_© KunzBotz_`, [
          {
        ...
        case 'simi':
				...
				buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @kunz.store`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'𝐾𝑈𝑁𝑍𝐵𝑂𝑇𝑍', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @kunz.store`,buttons,headerType:4}
...
❏ 「 \`\`\`𝙴𝙿𝙷𝙾𝚃𝙾 𝟹𝟼𝟶\`\`\` 」
├───────────────────
├ ${prefix}𝚠𝚎𝚝𝚐𝚕𝚊𝚜𝚜 𝚝𝚎𝚡𝚝
├ ${prefix}𝚖𝚞𝚕𝚝𝚒𝚌𝚘𝚕𝚘𝚛𝟹𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚠𝚊𝚝𝚎𝚛𝚌𝚘𝚕??𝚛 𝚝𝚎𝚡𝚝
├ ${prefix}𝚕𝚞𝚡𝚞𝚛𝚢𝚐𝚘𝚕𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚊𝚕𝚊𝚡𝚢𝚠𝚊𝚕𝚕𝚙𝚊𝚙??𝚛 𝚝𝚎𝚡𝚝
├ ${prefix}𝚕𝚒𝚐𝚑𝚝𝚝𝚎𝚡𝚝 𝚝𝚎𝚡𝚝
├ ${prefix}𝚋𝚎𝚊𝚞𝚝𝚒𝚏𝚞𝚕𝚏𝚕𝚘𝚠𝚎𝚛 𝚝𝚎𝚡𝚝
├ ${prefix}𝚙𝚞𝚙𝚙𝚢𝚌𝚞𝚝𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚛𝚘𝚢𝚊𝚕𝚝𝚎𝚡𝚝 𝚝𝚎??𝚝
├ ${prefix}𝚑𝚎𝚊𝚛𝚝𝚜𝚑𝚊??𝚎?? 𝚝𝚎𝚡𝚝
├ ${prefix}𝚋𝚒𝚛𝚝𝚑𝚍𝚊𝚢𝚌𝚊𝚔𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚊𝚕𝚊𝚡𝚢𝚜𝚝𝚢𝚕𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚑𝚘𝚕𝚘𝚐𝚛𝚊𝚖𝟹𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚛𝚎𝚎𝚗𝚗𝚎𝚘𝚗 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚕𝚘𝚜𝚜𝚢𝚌𝚑𝚛𝚘𝚖𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚛𝚎𝚎𝚗𝚋𝚞𝚜𝚑 𝚝𝚎𝚡𝚝
├ ${prefix}𝚖𝚎𝚝𝚊𝚕𝚕𝚘𝚐𝚘 𝚝𝚎𝚡𝚝
├ ${prefix}𝚗𝚘𝚎𝚕𝚝𝚎𝚡𝚝 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚕𝚒𝚝𝚝𝚎𝚛𝚐𝚘𝚕𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚝𝚎𝚡𝚝𝚌𝚊𝚔𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚜𝚝𝚊𝚛𝚜𝚗𝚒𝚐𝚑𝚝 𝚝𝚎𝚡𝚝
├ ${prefix}𝚠𝚘𝚘𝚍𝚎𝚗𝟹𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚝𝚎𝚡𝚝𝚋𝚢𝚗𝚊𝚖𝚎 𝚝𝚎𝚡𝚝
├ ${prefix}𝚠𝚛𝚒𝚝𝚎𝚐𝚊𝚕𝚊𝚌𝚢 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚊𝚕𝚊𝚡𝚢𝚋𝚊𝚝 𝚝𝚎𝚡𝚝
├ ${prefix}𝚜𝚗𝚘𝚠𝟹𝚍 𝚝𝚎𝚡𝚝
├ ${prefix}𝚋𝚒𝚛𝚝𝚑𝚍𝚊𝚢𝚍𝚊𝚢 𝚝𝚎𝚡𝚝
├ ${prefix}𝚐𝚘𝚕𝚍𝚙𝚕𝚊𝚢𝚋𝚞𝚝𝚝𝚘𝚗 𝚝𝚎𝚡𝚝
├ ${prefix}𝚜𝚒𝚕𝚟𝚎𝚛𝚙𝚕𝚊𝚢𝚋𝚞𝚝𝚝𝚘𝚗 𝚝𝚎𝚡𝚝
├ ${prefix}𝚏𝚛𝚎𝚎𝚏𝚒𝚛𝚎 𝚝𝚎𝚡𝚝
└───────────────────
`
                   sendButMessage(from, wibu, `_© KunzBotz_`, [
          {
...
wibu = `
MAU NGAPAIN HAYO V: 
MAU REFRESH OTAK KARENA DIPUTUSIN KAH 
YAUDAH PENCET LANJUTKAN AE :V
`
                   sendButMessage(from, wibu, `_© KunzBotz_`, [
          {
            buttonId: `!pornmenu`,
        ...
        break;
			...
			case 'delrespon':
                ...
                if (!isOwner) return reply(mess.OnlyOwner)
                    ...
                    const messimagethumb = JSON.parse(JSON.stringify(msg).replace('quotedM', 'm')).message
...
`
 ...
 _© KunzBotz_`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
❏ 「 \`\`\`𝙼𝙾𝚅𝙸𝙴 𝙼𝙴𝙽𝚄\`\`\` 」
├───────────────────
├ ${prefix}𝚍𝚛𝚊𝚔𝚘𝚛𝚘𝚗𝚐𝚘𝚒𝚗𝚐
├ ${prefix}𝚕𝚔𝟸𝟷 𝚚𝚞𝚎𝚛𝚢
├ ${prefix}𝚠𝚊𝚝𝚝𝚙𝚊𝚍 𝚞𝚛𝚕_𝚠𝚊𝚝𝚝𝚙𝚊𝚍
├ ${prefix}𝚠𝚊𝚝𝚝𝚙𝚊𝚍𝚜𝚎𝚊𝚛𝚌𝚑 𝚚𝚞𝚎𝚛𝚢
├ ${prefix}𝚌𝚎𝚛𝚙𝚎𝚗
├ ${prefix}𝚌𝚎𝚛𝚒𝚝𝚊𝚑𝚘𝚛𝚘𝚛
└───────────────────
`
...
├  ${prefix}𝚜𝚑𝚞𝚝𝚍𝚘𝚠𝚗
├  ${prefix}𝚐𝚎𝚝𝚚𝚞𝚘𝚝𝚎𝚍
├  ${prefix}𝚊𝚍𝚍𝚞𝚙𝚍𝚊𝚝𝚎 *𝚏𝚒𝚝𝚞𝚛𝚗𝚢𝚊*
├  ${prefix}𝚎𝚡𝚒𝚏 *𝚗𝚊𝚖𝚊|𝚊𝚞𝚝𝚑𝚘𝚛*
├  ${prefix}𝚜𝚎𝚠𝚊 𝚊𝚍𝚍/𝚍𝚎𝚕 w𝚊𝚔𝚝𝚞𝚗𝚢𝚊
├  ${prefix}𝚙𝚛𝚎𝚖𝚒𝚞𝚖 𝚊𝚍𝚍  𝚝𝚊𝚐|𝚗𝚘𝚖𝚘𝚛
├  ${prefix}𝚙𝚛𝚎𝚖𝚒𝚞𝚖 𝚍𝚎𝚕 @𝚝𝚊𝚐|𝚗𝚘𝚖𝚘𝚛
└───────────────────
`
...
└───────────────────
 ...
 ❏ 「 \`\`\`𝙾𝚃𝙷𝙴𝚁 𝙼𝙴𝙽𝚄\`\`\` 」
├───────────────────
├  ${prefix}𝚋𝚛𝚊𝚒𝚗𝚕𝚢 *𝚚𝚞𝚎𝚛𝚢*
├  ${prefix}𝚜𝚑𝚘𝚙𝚎𝚎 *𝚙𝚛𝚘𝚍𝚞𝚌𝚝*
├  ${prefix}𝚙𝚕𝚊𝚢𝚜𝚝𝚘𝚛𝚎 *𝚚𝚞𝚎𝚛𝚢*
├  ${prefix}𝚜𝚜𝚠𝚎𝚋 *𝚚𝚞𝚎𝚛𝚢*
├  ${prefix}𝚐𝚘𝚘𝚐𝚕𝚎 *𝚚𝚞𝚎𝚛𝚢*
├  ${prefix}𝚒𝚖𝚊𝚐𝚎 *𝚚𝚞𝚎𝚛𝚢*
├  ${prefix}𝚙𝚒𝚗𝚝𝚎𝚛𝚎𝚜𝚝 *𝚚𝚞𝚎𝚛𝚢*
├  ${prefix}𝚗𝚞𝚕𝚒𝚜 *𝚝𝚎𝚔𝚜*
├  ${prefix}𝚒𝚐𝚞𝚜𝚎𝚛 *𝚞𝚜𝚜𝚎𝚛𝚗𝚊𝚖𝚎*
├  ${prefix}𝚒𝚐𝚜𝚝𝚊𝚕𝚔 *𝚞𝚜𝚎𝚛𝚗𝚊𝚖𝚎*
├  ${prefix}𝚐𝚒𝚝𝚑𝚞𝚋𝚜𝚝𝚊𝚕𝚔 *𝚞𝚜𝚎𝚛𝚗𝚊𝚖𝚎*
├  ${prefix}𝚝𝚒𝚔𝚝𝚘𝚔𝚜𝚝𝚊𝚕𝚔 *𝚞𝚜𝚜𝚎𝚛𝚗𝚊𝚖𝚎*
├  ${prefix}𝚒𝚖𝚐𝟸𝚞𝚛𝚕 *𝚛𝚎𝚙𝚕𝚢 𝚏𝚘𝚝𝚘*
...
├  ${prefix}𝚝𝚎𝚋𝚊𝚔𝚐𝚊𝚖𝚋𝚊𝚛
├  ${prefix}𝚝𝚎𝚋𝚊𝚔𝚋𝚎𝚗𝚍𝚎𝚛𝚊
├  ${prefix}𝚜𝚞𝚒𝚝 *𝚋𝚊𝚝𝚞/𝚔𝚎𝚛𝚝𝚊𝚜/𝚐𝚞𝚗𝚝𝚒𝚗𝚐*
└───────────────────
 `
...
├  ${prefix}𝚜𝚝𝚒𝚌𝚔𝚎𝚛𝚊𝚗𝚒𝚖𝚎
├  ${prefix}𝚜𝚎𝚖𝚘𝚓𝚒 *𝚎𝚖𝚘𝚓𝚒*
├  ${prefix}𝚜𝚝𝚒𝚌𝚔𝚎𝚛 *𝚛𝚎𝚙𝚕𝚢 𝚏𝚘𝚝𝚘/𝚟𝚒𝚍𝚎𝚘*
├  ${prefix}𝚜𝚖𝚎𝚖𝚎 *𝚝𝚎𝚔𝚜|𝚝𝚎𝚔𝚜*
├  ${prefix}𝚜𝚠𝚖 *𝚙𝚊𝚌𝚔|𝚊𝚞𝚝𝚑𝚘𝚛*
├  ${prefix}𝚝𝚊𝚔𝚎 *𝚙𝚊𝚌𝚔|𝚊𝚞𝚝𝚑𝚘𝚛* 
├  ${prefix}𝚝𝚘𝚟𝚒𝚍𝚎𝚘 *𝚛𝚎𝚙𝚕𝚢 𝚜𝚐𝚒𝚏*
└───────────────────
`
 ...
 𝙆𝙄𝙍??𝙂𝙄𝙍𝙄𝘽𝙊𝙏☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
*「 𝐾𝑈𝑁𝑍𝐵𝑂𝑇𝑍 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Kamu Telah Terdaftar Di Database Bot*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://i.ibb.co/tsFbjpw/70edd6af9fcc.jpg'
...
\`\`\`▢ Link : instagram.com/${ini_result.username}\`\`\`
`
             ikyy.sendMessage(from, ini_buffer, image, { caption: ini_txt, thumbnail: Buffer.alloc(0) })
             break
      case 'stalktiktok':
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'sc': 
       case 'src':
              textImg(`gada sc sc an nonton aja bokep nih https://bit.ly/3zmSaFg`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu100) {
             ikyy.sendMessage(_.jid, bc100, image, {quoted: freply, caption: `*「 BOTZ NEWS 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu100) {
             ikyy.sendMessage(_.jid, 
			{"contentText": `*「 BOTZ NEWS 」*\n\n${body.slice(4)}`,
			"footerText": '𝐾𝑢𝑛𝑧 𝐵𝑜𝑡𝑧',
			"buttons": [
			{"buttonId": `#oke`,
			"buttonText": {"displayText": "Kunz Ganteng🐦"
			},"type": "RESPONSE"}
			], "headerType": 'LOCATION',
...
//------------------< Enable/Disable >-------------------
       ...
       case 'antilink':
              ...
              case 'clone':
					...
					if (ikyy.message === undefined || ikyy.message === null) return reply('❬ SUCCSESS ❭')
					mentioned = iky.message.contextInfo.mentionedJid[0]
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/kunz.store`)
             break
      case 'ikyygroup':
             reply('MASTAH DOANG KAGAK JOIN :V      https://chat.whatsapp.com/I3330Da0itL8xCyKxdGuWs')
             break
